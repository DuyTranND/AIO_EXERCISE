...
if __name__ == "__main__":
    bg1_image = cv2.imread(
        r"F:\AIO\AIO_Homework\AIO_EXERCISE\Module2\Week2\GreenBackground.png", 1)
    bg1_image = cv2.resize(bg1_image, (678, 381))

    ob_image = cv2.imread(
        r'F:\AIO\AIO_Homework\AIO_EXERCISE\Module2\Week2\Object.png', 1)
    ob_image = cv2.resize(ob_image, (678, 381))

    bg2_image = cv2.imread(
        r'F:\AIO\AIO_Homework\AIO_EXERCISE\Module2\Week2\NewBackground.jpg', 1)
